...
<div class="list-group">
    <a href="/books/info?id=${book.id}" class="list-group-item list-group-item-action" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Нажмите чтобы узнать о ${book.name}">${book.name} - <span
